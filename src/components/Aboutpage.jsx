        ...
        <Row className="textbackground">
          <Col md={7}>
            ...
            <p className="aboutdetails">
              ...
              proposer des solutions fluides et pragmatiques. Pour cela,
              ...
              et MySQL en Databases relationnelles ou Mongo DB lorsque le non-relationnel s'avère pertinent...<br /><br /> Aussi, je suis prêt à découvrir de nouvelles technologies afin d'améliorer mes compétences globales 
              et apporter un plus à l'équipe de développement. Par ailleurs, j'ai développé un certain nombre de soft-skills du haut de mes 32 ans : très sociable, serviable, bilingue, motivé et motivant.
            ...
            <Col md={6} className="project-card">
              <Card className="cert-card-view">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    <ReadMore text="C'est en effet cette certification de Meta pour être 'job-ready' dans le Backend m'a appris énormément de choses et m'a permis de consolider des notions que j'avais vaguement apprises.
